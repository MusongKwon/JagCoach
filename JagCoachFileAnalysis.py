...
import sys
from LLM import evaluate_speech
import json
...
def get_elements(file_path):
    ...
    c = os.getcwd()+os.path.join(config.UPLOAD_FOLDER, "/JagCoach-IncludingAudioStats/uploads/processed_audio")  # Use config path
...
if __name__ == "__main__":
    ...
    try:
        ...
        evaluate_speech(json_file, "optimal_metrics.json", False)
